...
python tools/demo.py image -f exps/nano.py -n yolox-nano -c /mnt/nvme0n1/hieudao/RotatedObjectDetection/rotate_YOLOX/YOLOX_outputs/nano/epoch_10_ckpt.pth --path inference/images --conf 0.25 --nms 0.1 --tsize 640 --save_result --device [cpu/gpu]
