...
python tools/demo.py image -f exps/nano.py -n yolox-nano -c epoch_60_ckpt.pth --path inference/images --conf 0.5 --nms 0.5 --tsize 640 --save_result --device [cpu/gpu]
