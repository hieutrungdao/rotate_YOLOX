...
python tools/demo.py image -f exps/nano.py -n yolox-nano -c epoch_65_ckpt.pth --path inference/images --conf 0.25 --nms 0.5 --tsize 640 --save_result --device [cpu/gpu]
