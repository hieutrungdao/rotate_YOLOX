...
python tools/demo.py image -f exps/nano.py -n yolox-nano -c epoch_80_ckpt.pth --path inference/images --conf 0.45 --nms 0.4 --tsize 640 --save_result --device [cpu/gpu]
