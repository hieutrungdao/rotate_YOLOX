...
python tools/demo.py image -f exps/pharma.py -n yolox-s -c YOLOX_outputs/pharma/epoch_240_ckpt.pth --path inference/images --conf 0.25 --nms 0.5 --tsize 640 --save_result --device [cpu/gpu]
